...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        for layer_num, blk in enumerate(self.blocks):
            ...
            save_attns.append(attn_weights)
        ...
        return hidden_states, save_attns
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor, image_grid_thw: Optional[torch.LongTensor] = None):
        ...
        image_embeds,save_attns = self.visual(pixel_values, grid_thw=image_grid_thw)
        split_sizes = (image_grid_thw.prod(-1) // self.visual.spatial_merge_size**2).tolist()
        image_embeds = torch.split(image_embeds, split_sizes)
        return image_embeds, save_attns
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                image_embeds,save_attns = self.get_image_features(pixel_values, image_grid_thw)
        ...
        return output,save_attns if return_dict else output.to_tuple()
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        outputs,visual_attns = self.model(
            input_ids=input_ids,
        ...
        ), visual_attns # add return visual attns
